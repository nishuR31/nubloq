...
export default function FaqSection() {
  return (
    ...
    <section className="flex flex-col w-full p-6 py-10 mx-auto text-gray-800 transition-all ease-in bg-no-repeat bg-cover animate-slideInLeft delay-3000 dark:bg-left dark:bg-cover min-h-content bg-wave dark:bg-blackWave dark:text-gray-200">
      <h2
