...
const Blog = () => {
    ...
    return (
        <div className="pt-16 transition-all ease-in-out bg-transparent animate-slideInLeft delay-[2s]">
            <div className='flex flex-col items-center max-w-6xl mx-auto space-y-4 text-center'>
                <h1 className='pt-10 text-4xl font-bold text-center text-app animate-bounce'>Our Blogs</h1>
