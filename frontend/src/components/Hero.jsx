  ...
  return (
    <div className=" transition-all delay-3000 ease-in-out  bg-home-light dark:bg-home-dark bg-no-repeat bg-fit bg-bottom dark:bg-center px-4 h-screen ">
      <div className='max-w-7xl mx-auto flex flex-col md:flex-row items-center h-[600px] my-10 md:my-0'>
        ...
        <h1 className="text-4xl md:text-6xl text-gray-800 font-bold mb-4 dark:text-white text-justify mt-5">Explore the Latest Tech <span className="text-red-500">&</span> Web Trends</h1>
         <br />
        ...
        <div className=' flex items-center justify-center '>
            <img src={heroImg} alt="" className='hidden md:block md:h-[550px] md:w-[550px]'/>
        </div>
      </div>
    </div>
  )
