...
const BlogCard = ({ blog }) => {
  ...
  return (
    <div className="bg-transparent backdrop-blur-sm dark:border-gray-600 p-5 rounded-2xl shadow-lg border hover:scale-[102%] transition-all ease-in-out delay-3000 ">
