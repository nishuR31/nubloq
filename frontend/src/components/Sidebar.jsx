...
const Sidebar = () => {
  return (
    <div className="hidden animate-slideInLeft transition-all delay-[2s] ease-in  fixed md:block border-r-2 bg-app bg-no-repeat bg-cover  border-input  w-[250px] py-40  space-y-2 min-h-screen z-10">
